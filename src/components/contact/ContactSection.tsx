...
export default function ContactSection() {
  ...
  return (
          <section className="bg-gradient-to-br from-zinc-50 via-white to-primary-50/30 dark:from-zinc-900 dark:via-black dark:to-primary-900/10 py-16 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          
          <div className="text-center mb-12">
            <Badge variant="secondary" className="bg-primary-100 text-primary-800 dark:bg-primary-900/30 dark:text-primary-300 border-primary-200 dark:border-primary-800 mb-4">
              Contacto Directo
            </Badge>
          ...
          <Card className="border-0 shadow-2xl bg-white/95 dark:bg-zinc-900/95 backdrop-blur">
            <CardContent className="p-8 lg:p-12">
                      ...
                      <div className="flex flex-col items-start space-y-3">
                        ...
                        <div>
                          ...
                          <p className={`text-sm mt-1 ${
                            isActive ? 'text-primary-100' : 'text-zinc-500 dark:text-zinc-400'
                          }`}>
                            {option.description}
                          </p>
                        </div>
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-primary-500/5 to-primary-600/5 rounded-xl"></div>
                <div className="relative">
