...
export const ContactEmail: React.FC<ContactEmailProps> = ({
  ...
  return (
    <Html>
      ...
      <Tailwind>
        <Body className="bg-gradient-to-br from-zinc-50 to-primary-50 font-sans my-auto mx-auto max-w-[600px]">
          
          <Container className="mx-auto p-6 bg-white shadow-2xl rounded-2xl border border-zinc-200">
            
            <Section className="border-t-4 border-primary-500 pt-6">
              
              <Row className="py-6">
                <Column>
                  <Text className="text-center font-bold text-3xl mb-3 text-zinc-900">
                    Hola Mena Inmobiliaria,
                  </Text>
              ...
              {userType === "buyer" ? (
                <Row className="py-4">
                  ...
                  <Text className="text-lg font-bold text-primary-800 mb-4 border-b border-primary-300 pb-2">
                      ...
                      <div className="space-y-3">
                        ...
                        <Text className="text-base">
                          ...
                          <span className="ml-2 text-zinc-700">{ciudad || "N/A"}</span>
                                              ...
                                              <Text className="text-lg font-bold text-primary-800 mt-6 mb-4 border-b border-primary-300 pb-2">
            ...
            <Text className="text-center text-sm text-zinc-500 py-6 border-t border-zinc-200">
              © 2024 | Mena Inmobiliaria | Colombia | www.menainmobiliaria.com
            </Text>
          </Container>
        </Body>
      </Tailwind>
