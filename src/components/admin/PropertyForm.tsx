          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="mt-1 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-700 focus:border-primary-500 dark:focus:border-primary-400"
                ...
                <div>
                  ...
                  <Select name="city" value={formData.city} onValueChange={(value) => handleInputChange({ target: { name: 'city', value } } as any)}>
                    <SelectTrigger className="mt-1 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-700 focus:border-primary-500 dark:focus:border-primary-400">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Input
                      ...
                      required
                      min="0"
                      className="pl-10 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-700 focus:border-primary-500 dark:focus:border-primary-400"
                      placeholder="0"
                    />
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                />
                {imageUrls.length > 0 && (
                  <Badge variant="secondary" className="mt-2 bg-primary-100 text-primary-800 dark:bg-primary-900/30 dark:text-primary-300">
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-zinc-200 dark:border-zinc-700">
              ...
              <Button
                type="submit"
                disabled={uploading}
                className="bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold"
              >
                {uploading ? (
                  <>
